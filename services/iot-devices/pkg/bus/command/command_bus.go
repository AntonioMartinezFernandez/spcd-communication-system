...
import (
	...
	mutex "github.com/AntonioMartinezFernandez/services/iot-devices/pkg/distributed-sync"
...
func InitCommandBus(logger amf_logger.Logger, mutex mutex.MutexService) *CommandBus {
	return &CommandBus{
